...
# TH 8004
python src/train.py --experimentID 8004 --gpu_id $1 --task both --dataset tools_home --shuffle \
...
# MI 8005
python src/train.py --experimentID 8005 --gpu_id $1 --task both --dataset musical_instruments --shuffle \
...
# TOG 8006
python src/train.py --experimentID 8006 --gpu_id $1 --task both --dataset toys_games --shuffle \

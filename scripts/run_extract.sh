...
python src/extract.py --data_path=./data/amazon/tools_home/ --count_threshold=150 --run_mapping
python src/extract.py --data_path=./data/amazon/musical_instruments/ --count_threshold=50 --run_mapping